...
namespace SplitScreenRegions.Framework.Interfaces
{
    ...
    public interface IGenericModConfigMenuApi
    {
        ...
        ****/
        ...
        /// <param name="height">The pixel rightTextHeight to allocate for the option in the form, or <c>null</c> for a standard input-sized option. This is called and cached each time the form is opened.</param>
        /// <param name="fieldId">The unique field ID for use with <see cref="OnFieldChanged"/>, or <c>null</c> to auto-generate a randomized ID.</param>
